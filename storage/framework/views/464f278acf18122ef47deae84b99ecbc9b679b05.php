                            ...
                            <div class="row animated">
                                <article>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                                        <img class="img-responsive" src="<?php echo e(URL::asset('images/site/girl1.jpg')); ?>" alt="img">
                                        <header>
                                ...
                                <article>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                                        <img class="img-responsive" src="<?php echo e(URL::asset('images/site/girl2.jpg')); ?>" alt="img">
                                        <header>
                                ...
                                <article>
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                                        <img class="img-responsive" src="<?php echo e(URL::asset('images/site/girl3.jpg')); ?>" alt="img">
                                        <header>
                                            <h3 class="block-title-3">Consectetur adipiscing</h3>
                                        </header>
                                        <p>
