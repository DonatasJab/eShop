    ...
    <div class="container main-container headerOffset">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-5 rightSidebar">
                <h4 class="caps"><a href="<?php echo e(route('home')); ?>"><i class="fa fa-chevron-left"></i> Grįžti į parduoutuvę</a></h4>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 rightSidebar">
                <div class="w100 cartMiniTable">
                    <table id="cart-summary" class="std table">
                        ...
                        <tr>
                            <td>Kaina</td>
                            <td class="price"><?php echo e($total); ?> €</td>
                        </tr>
                        <tr>
                            <td>Siuntimas</td>
                        ...
                        <tfoot>
                            <tr>
                                <td>Išviso</td>
                                <td class=" site-color" id="total-price"><?php echo e($total); ?> €</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
