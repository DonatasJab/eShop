                ...
                <div class="slider-content">
                    ...
                    <div class="slider slider-v1" data-cycle-swipe=true data-cycle-prev=".prevControl" data-cycle-next=".nextControl" data-cycle-loader="wait">
                        <div class="slider-item slider-item-img1">
                            ...
                            <img src="<?php echo e(URL::asset('images/slider/slider1.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img">
                        </div>
                        <div class="slider-item slider-item-img3 ">
                            ...
                            <img src="<?php echo e(URL::asset('images/slider/slider4.jpg')); ?>" class="img-responsive parallaximg sliderImg" alt="img">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                <div class="product">
                                    <div class="image">
                                        <?php foreach($categories as $category): ?>
                                            <?php if($product->category_id == $category->id): ?>
                                                <a href="<?php echo e(route('product.home', ['category' => $category->slug, 'slug' => $product->slug])); ?>"><img src="<?php echo e($product->image); ?>" alt="<?php echo e($product->title); ?>" class="img-responsive"></a>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="description">
                                        <?php foreach($categories as $category): ?>
                                            <?php if($product->category_id == $category->id): ?>
                                                <h4><a href="<?php echo e(route('product.home', ['category' => $category->slug, 'slug' => $product->slug])); ?>"><?php echo e($product->title); ?></a></h4>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                        <p><?php echo e(str_limit($product->description, 60)); ?> </p>
                                    </div>
                                    <div class="price"><span><?php echo e($product->price); ?> €</span></div>
                                    <div class="action-control">
                                        <a href="<?php echo e(route('product.addToCart', ['id' => $product->id])); ?>" class="btn btn-primary"><span class="add2cart"><i class="glyphicon glyphicon-shopping-cart"></i> Į krepšelį</span> </a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('js/jquery.cycle2.min.js')); ?>"></script>
